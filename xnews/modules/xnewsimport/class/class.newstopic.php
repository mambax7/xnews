...
class xni_NewsTopic extends XoopsTopic
{
	...
	function xni_NewsTopic($topicid=0, $subprefix='')
	{
	...
	function MakeMyTopicSelBox($none=0, $seltopic=-1, $selname="", $onchange="", $checkRight = false, $perm_type='xni_view')
	{
	    $perms='';
	    if ($checkRight) {
	        global $xoopsUser;
	...
	function getAllTopics($table_name = "nw_topics", $checkRight = true, $permission = "xni_view")
	{
	    $topics_arr = array();
