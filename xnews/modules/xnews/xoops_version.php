<?php
// $Id: xoops_version.php 8207 2011-11-07 04:18:27Z beckmi $
//  ------------------------------------------------------------------------ //
...
$modversion['config'][$i]['options'] = array('_MI_NW_NEWSCLASSIC' => 'Classic','_MI_NW_NEWSBYTOPIC' => 'Bytopic');
...
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 1;
$modversion['config'][$i]['options']	= array('_MI_NW_DISPLAYNAME1' => 1, '_MI_NW_DISPLAYNAME2' => 2, '_MI_NW_DISPLAYNAME3' => 3);
...
$modversion['config'][$i]['options'] = array('_MI_NW_UPLOAD_GROUP1' => 1, '_MI_NW_UPLOAD_GROUP2' => 2, '_MI_NW_UPLOAD_GROUP3' => 3);
