...
function NewsCloner() {
    ...
    echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'><tr class='bg3'><td align='center'>" . _AM_NW_CLONER_NAME . "</td><td align='center'>" . _AM_NW_CLONER_DIRFOL . "</td><td align='center'>" . _AM_XNEWS_SUBPREFIX . "</td><td align='center'>" . _AM_NW_CLONER_VERSION . "</td><td align='center'>" . _AM_NW_ACTION . "</td><td align='center'>" . _AM_NW_CLONER_ACTION_INSTALL . "</td></tr>";
...
function NewsClonerApply() {
    ...
    include_once __DIR__ . '/cloner.php';
...
function CloneDelete()
{
    ...
    xoops_cp_header();
    $indexAdmin = new ModuleAdmin();
    echo $indexAdmin->addNavigation("clone.php?op=cloner");
    //
    xoops_load('XoopsFormLoader');
    //
    if (!isset($_GET['clone_id'])) {
...
$op = XoopsRequest::getString('op', 'cloner');
