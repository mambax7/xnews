<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_XNI_HELP_HEADER}>

    <h4 class="odd">Description</h4>

    <p class="even">This module is xNews Importer which imports data from news 1.64 and above to xNews and Clones<br><br>
        Imports data from xNews 1.6x and xNews Clones....<br> <br>
    </p>
