...
<input type="checkbox" name="agree" value="1" checked> <label for="agree">I agree </label><br><br>
<input type="radio" name="radioquestion" id="rqa" value="1"> <label for="rqa">one</label><br>
<input type="radio" name="radioquestion" id="rqb" value="2" checked> <label for="rqb">two</label><br>
