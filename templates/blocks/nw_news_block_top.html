...
html>body #tabNavigation a,
html>body #tabNavigation a:link,
html>body #tabNavigation a:visited {
    border-bottom: none;
    padding: 4px 6px 4px 6px;
}

\head+body #tabNavigation a,
\head+body #tabNavigation a:link,
\head+body #tabNavigation a:visited {
    padding: 3px 6px 3px 6px;
}
...
html>body #tabNavigation .selectedTab a,
html>body #tabNavigation .selectedTab a:link,
html>body #tabNavigation .selectedTab a:visited {
    padding: 4px 5px 5px 5px;
}

\head+body #tabNavigation .selectedTab a,
\head+body #tabNavigation .selectedTab a:link,
\head+body #tabNavigation .selectedTab a:visited,
\head+body #tabNavigation .selectedTab a:hover {
    padding: 3px 5px 4px 5px;
}
...
html>body #tabNavigation .selectedTab a:link,
html>body #tabNavigation .selectedTab a:visited,
html>body #tabNavigation .selectedTab a:hover {
    padding: 2px 4px 2px 4px;
    top: 0;
}

head:first-child+body #tabNavigation .selectedTab a,
head:first-child+body #tabNavigation .selectedTab a:link,
head:first-child+body #tabNavigation .selectedTab a:visited,
head:first-child+body #tabNavigation .selectedTab a:hover {
    margin: -1px 0 0 0;
    padding: 2px 4px 4px 4px;
    top: 0;
}

head:first-child+body ul[id]#tabNavigation .selectedTab a,
head:first-child+body ul[id]#tabNavigation .selectedTab a:link,
head:first-child+body ul[id]#tabNavigation .selectedTab a:visited,
head:first-child+body ul[id]#tabNavigation .selectedTab a:hover {
    padding: 3px 4px 3px 4px;
    top: 1px;
}
...
#tabNavigation a:link,
#tabNavigation a:visited {
    background: url(<{$block.imagesurl}>unselectedEnd.gif) <{$block.color4
;
...
#tabNavigation a:hover {
    background: url(<{$block.imagesurl}>unselectedEnd.gif) <{$block.color5
;
}>  no-repeat scroll top right;
    color: #FFF;
...
#tabNavigation .fixTabsIE a,
#tabNavigation .fixTabsIE a:link,
#tabNavigation .fixTabsIE a:visited,
#tabNavigation .fixTabsIE a:hover {
    display: none;
}
...
head:first-child+body #tabNavigation a,
head:first-child+body #tabNavigation a:link,
head:first-child+body #tabNavigation a:visited {
    border-right: 1px solid #666;
    margin: 0 0 0 -15px;
    padding: 3px 5px 3px 27px;
    position: relative;
...
\html head:first-child+body #tabNavigation .selectedTab a,
\html head:first-child+body #tabNavigation .selectedTab a:link,
\html head:first-child+body #tabNavigation .selectedTab a:visited,
\html head:first-child+body #tabNavigation .selectedTab a:hover {
...
html #tabNavigation .fixTabsIE a/* */,
html #tabNavigation .fixTabsIE a:link/* */,
html #tabNavigation .fixTabsIE a:visited/* */ {
    background: #CCC;
    border-bottom: none;
    border-left: 1px solid #FFF;
    border-right: none;
...
ul#tabNavigation li.selectedTab a,
ul#tabNavigation li.selectedTab a:link,
ul#tabNavigation li.selectedTab a:visited {
    background: <{$block.color3
;
}>;
    border-bottom: none;
...
html #tabNavigation a/* */,
html #tabNavigation a:link/* */, html #tabNavigation a:visited/* */ {
    height: auto;
    margin: 0 -4px 0 0;
}

html>body #tabNavigation a,
html>body #tabNavigation a:link, html>body #tabNavigation a:visited {
    margin: 0;
}
...
<{else}>
    <li><a href="<{$block.url}>nwTab=<{$onetab.id}>"><{$onetab.title}></a></li>
<{/if}>
<{/foreach}>
...
<{foreach item=onenews from=$block.news}>
    <div class="itemBody">
        ...
        <span class="itemStats">&nbsp;&nbsp;<{$onenews.author}> <{$block.lang_on}> <{$onenews.date}> - <{if $block.use_rating}> <{$onenews.rating}>/10 (<{$onenews.number_votes}>)<{/if}>, <{$onenews.hits}> <{$block.lang_reads}></span>
    </div>
        ...
        <td>
            ...
            <tr>
                ...
                <{if $block.spotlight.read_more}>
                    <hr width='98%'>
                    <div align='right'>
                        <a href="<{$block.newsmodule_url}>/article.php?storyid=<{$block.spotlight.id}>"><{$block.lang_read_more}></a> &nbsp;&nbsp;&nbsp;
                    </div>
                    <hr width='98%'>
                <{/if}>
                </td>
        ...
        <td>
            ...
            <{if $news.id != $block.spotlight.id}>
                ...
                <{else}>
                    [<{$news.rating}>]
                <{/if}>-->
                <a style="font-size: 10px;" href="<{$block.newsmodule_url}>/article.php?storyid=<{$news.id}>" <{$news.infotips}>><{$news.title}></a> <br><{$news.teaser}></li>
            <{/if}>
            <{/foreach}>
            </ul>
        </td>
